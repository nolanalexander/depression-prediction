### Permutation testing of the Elastic Net Model
...
if(generate_new_split){
  ...
  # Assigns dep_var to random chance
  behavioral_df[dep_var] <- rbinom(n=nrow(behavioral_df), size=1, prob=0.5)
...
if(!tuning_two_params & !tuning_one_param){
  ...
  setwd(paste0(wd,"/Results/Logistic_Regression/Behavioral/Runs/Permutations/"))
